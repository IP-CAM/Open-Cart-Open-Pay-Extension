<form class="form-horizontal">
  <fieldset id="payment">
    ...
    <div class="form-group required">
      <label class="col-sm-2 control-label" for="input-cc-number"><?php echo $entry_cc_holder_name; ?></label>
      <div class="col-sm-10">
        <input type="text" name="cc_holder_name" value="" placeholder="<?php echo $entry_cc_holder_name; ?>" id="input-cc-name" class="form-control" />
      </div>
    </div>
    <div class="form-group required">
...
$('#button-confirm').bind('click', function() {
  $.ajax({
    url: 'index.php?route=payment/open_pay/send',
    type: 'post',
    data: $('#payment :input'),
    dataType: 'json',
    beforeSend: function() {
